...
class AsPath implements CastsAttributes
{
    ...
    /**
     * Transform the PostgreSQL path to the database.
     */
    protected function transformPgsqlPathToDatabase(string $path): string
    {
        ...
        /* Postgres 16 allow using symbol "-" in the path. Docs: https://www.postgresql.org/docs/16/ltree.html */
        //return Str::replace('-', '_', $path);
        return $path;
    }

    /**
     * Transform the PostgreSQL path value from the database.
     */
